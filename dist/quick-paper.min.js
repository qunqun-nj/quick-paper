...
* License: MIT
*/!function(){var t=Object.prototype.toString;function e(e){return null==e?void 0===e?"[object Undefined]":"[object Null]":t.call(e)}var n=function(t,n){return null!==n&&"object"===_typeof2(n)&&t.indexOf(n.nodeType)>-1&&!function(t){if(null===t||"object"!==_typeof2(t)||"[object Object]"!=e(t))return!1;if(null===Object.getPrototypeOf(t))return!0;for(var n=t;null!==Object.getPrototypeOf(n);)n=Object.getPrototypeOf(n);return Object.getPrototypeOf(t)===n}(n)},r=function(t){var n=_typeof2(t);return"string"===n||"object"===n&&null!=t&&!Array.isArray(t)&&"[object String]"===e(t)},o=function(t){if(!function(t){var e=_typeof2(t);return null!=t&&("object"===e||"function"===e)}(t))return!1;var n=e(t);return"[object Function]"===n||"[object AsyncFunction]"===n||"[object GeneratorFunction]"===n||"[object Proxy]"===n},i=function(t){return Array.isArray(t)};function s(t){/^[_$]/.test(t)&&console.error("The beginning of _ or $ is not allowed："+t)}var l=1;function c(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:[],o={},i=[];if(!r(t))return{type:"component",options:t,attrs:{},children:[]};for(var s in e)/^@/.test(s)?o[s.replace(/^@/,"q-on:")]=e[s]:/^:/.test(s)?o["q-bind"+s]=e[s]:o[s]=e[s];for(var l,c=0;c<n.length;c++)l=n[c],r(l)?/\{\{[^}]+\}\}/.test(l)?i.push({type:"bindText",content:('" '+l+' "').replace(/\{\{([^}]+)\}\}/g,'"+$1+"')}):i.push({type:"text",content:l}):i.push(l);return{type:"none",tagName:t,attrs:o,children:i}}function a(t){for(var e=(t+"").toLowerCase(),n=(t+"").toUpperCase(),r="",o=!1,i=0;i<t.length;i++)"-"!=t[i]?o?(r+=n[i],o=!1):r+=e[i]:o=!0;return r}var u={blankReg:new RegExp("[\\x20\\t\\r\\n\\f]"),blanksReg:/^[\x20\t\r\n\f]{0,}$/,identifier:/^[a-zA-Z_$][0-9a-zA-Z_$]{0,}$/},_=["+","-","*","/","%","&","|","!","?",":","[","]","(",")",">","<","="],f=["+","-","*","/","%","&","|","!","?",":",">","<","=","<=",">=","==","===","!=","!=="];function h(t,e,n){e=e.trim();var o=-1,i=null,s=function(){return i=o++<e.length-1?e[o]:null},l=function(t){return e.substring(o,t+o>e.length?e.length:t+o)};s();for(var c=[];!(o>=e.length);)if(_.indexOf(i)>-1)if(["&","|","="].indexOf(i)>-1)if(["==="].indexOf(l(3))>-1)c.push(l(3)),o+=2,s();else{if(!(["&&","||","=="].indexOf(l(2))>-1))throw new Error("Illegal expression : "+e+"\nstep='analyseExpress',index="+o);c.push(l(2)),o+=1,s()}else["!=="].indexOf(l(3))>-1?(c.push(l(3)),o+=2,s()):[">=","<=","!="].indexOf(l(2))>-1?(c.push(l(2)),o+=1,s()):(c.push(i),s());else if(['"',"'"].indexOf(i)>-1){var a="",h=i;for(s();i!=h;){if(o>=e.length)throw new Error("String unclosed error : "+e+"\nstep='analyseExpress',index="+o);a+=i,s()}c.push(a+"@string"),s()}else if(/\d/.test(i)){var p="no";a=i;for(s();o<e.length;){if(/\d/.test(i))a+=i,"error"==p&&(p="yes");else{if("."!=i||"no"!=p)break;a+=i,p="error"}s()}"error"==p&&(a+="0"),c.push(+a)}else if(["null","true"].indexOf(l(4))>-1)c.push({null:null,true:!0}[l(4)]),o+=3,s();else if(["false"].indexOf(l(5))>-1)c.push({false:!1}[l(5)]),o+=4,s();else if(["undefined"].indexOf(l(9))>-1)c.push({undefined:void 0}[l(9)]),o+=8,s();else if(u.blankReg.test(i))do{s()}while(u.blankReg.test(i)&&o<e.length);else{var d=!1;if("."==i&&(d=!0,s()),!u.identifier.test(i))throw new Error("Illegal express : "+e+"\nstep='analyseExpress',index="+o);for(var m=1;o+m<=e.length&&u.identifier.test(l(m));)m+=1;if(d)c.push("["),c.push(l(m-1)+"@string"),c.push("]");else{var g=l(m-1),v=g in n?n[g]:t[g];c.push(r(v)?v+"@string":v)}o+=m-2,s()}for(var y=0,b=0;b<c.length;b++)["+","-"].indexOf(c[b])>-1&&(0==b||f.indexOf(c[y-1])>-1)?(c[y++]=+(c[b]+c[b+1]),b+=1):c[y++]=c[b];return c.length=y,c}var p=function(t){return"string"==typeof t?t.replace(/@string$/,""):t};function d(t){for(var e,n=0,r=0;r<t.length;r++)"!"==t[r]?t[n]=!t[++r]:t[n]=t[r],n+=1;if(1==n)return p(t[0]);for(t.length=n,n=0,r=0;r<t.length;r++)"*"==t[r]?t[n-1]=p(t[n-1])*p(t[++r]):"/"==t[r]?t[n-1]=p(t[n-1])/p(t[++r]):"%"==t[r]?t[n-1]=p(t[n-1])%p(t[++r]):t[n++]=t[r];if(1==n)return p(t[0]);for(t.length=n,n=0,r=0;r<t.length;r++)"+"==t[r]?t[n-1]="string"==typeof(e=p(t[n-1])+p(t[++r]))?e+"@string":e:"-"==t[r]?t[n-1]=p(t[n-1])-p(t[++r]):t[n++]=t[r];if(1==n)return p(t[0]);for(t.length=n,n=0,r=0;r<t.length;r++)">"==t[r]?t[n-1]=p(t[n-1])>p(t[++r]):"<"==t[r]?t[n-1]=p(t[n-1])<p(t[++r]):"<="==t[r]?t[n-1]=p(t[n-1])<=p(t[++r]):">="==t[r]?t[n-1]=p(t[n-1])>=p(t[++r]):t[n++]=t[r];if(1==n)return p(t[0]);for(t.length=n,n=0,r=0;r<t.length;r++)"=="==t[r]?t[n-1]=p(t[n-1])==p(t[++r]):"==="==t[r]?t[n-1]=p(t[n-1])===p(t[++r]):"!="==t[r]?t[n-1]=p(t[n-1])!=p(t[++r]):"!=="==t[r]?t[n-1]=p(t[n-1])!==p(t[++r]):t[n++]=t[r];if(1==n)return p(t[0]);for(t.length=n,n=0,r=0;r<t.length;r++)"&&"==t[r]?(t[n-1]=p(t[n-1])&&p(t[1+r]),r+=1):"||"==t[r]?(t[n-1]=p(t[n-1])||p(t[1+r]),r+=1):t[n++]=t[r];if(1==n)return p(t[0]);for(t.length=n,n=0,r=0;r<t.length;r++)"?"==t[r]?(t[n-1]=p(t[n-1])?p(t[r+1]):p(t[r+3]),r+=3):t[n++]=t[r];if(1==n)return p(t[0]);throw t.length=n,new Error("Unrecognized expression : ["+t.toString()+"]")}var m=function(t){for(var e=!0;e;){e=!1;for(var n=[],o=[],i=!1,s=0;s<t.length;s++)if("["==t[s]&&0!=s&&"]"!=t[s-1]){if(i){n.push("[");for(var l=0;l<o.length;l++)n.push(o[l])}else i=!0;o=[]}else if("]"==t[s]&&i){e=!0;var c=d(o),a=n[n.length-1][c];n[n.length-1]=r(a)?a+"@string":a,i=!1}else i?o.push(t[s]):n.push(t[s]);t=n}return t},g=function(t){for(var e=[],n=[],r=0;r<t.length;r++)"["==t[r]?n=[]:"]"==t[r]?e.push(d(n)):n.push(t[r]);return e};function v(t,e,n){var o,i=function t(e,n,o){if(n.indexOf("(")>-1){for(var i=[],s=[],l=0,c=0;c<n.length;c++)if("("==n[c])l>0&&s.push("("),l+=1;else if(")"==n[c]){if(l>1&&s.push(")"),0==(l-=1)){var a=d(t(e,s));i.push(r(a)?a+"@string":a),s=[]}}else l>0?s.push(n[c]):i.push(n[c]);n=i}return m(n)}(t,e);if("["!=i[0])o=[d(i)];else if("]"==i[i.length-1])o=g(i);else{var s=i.lastIndexOf("]"),l=g(i.slice(0,s+1)),c=i.slice(s+1);c.unshift(function(t,e,n){for(var r=(e[0]in n?n[e[0]]:t[e[0]]),o=1;o<e.length;o++)try{r=r[e[o]]}catch(r){throw console.error({target:t,scope:n,expressArray:e,index:o}),r}return r}(t,l,n)),o=[d(c)]}return o}
/*!
