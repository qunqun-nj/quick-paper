        ...
        while (hadMore) {
            ...
            for (var i = 0; i < expressArray.length; i++) {
                ...
                // 计算后放回主数组
                    ...
                    newExpressArray[newExpressArray.length - 1] = isString$1(_value) ? _value + "@string" : _value;
